...
export default function About() {
     ...
     <section id="skill">
          ...
          <span className="skillDesc">I am a skilled and passionate web designer with experience in creating visually<span className="introName">Blessing Ajiboye</span> 
